...
用 Go-importer 方案写入的性能对比

A. 图遍历`GO FROM $vid over e`
 
B. 取 出度

twitter 里面前1万个vid

| vid  |   A.1 原来的nebula进程，跑语句A  |   A.2 新的方案，跑语句 A  |  B.1 原来的nebula，跑语句 `GO FROM $vid over e yield e._dst as id \| yield count ($-.id)`  | B.2 新的方案，跑`outdegree(vid)` |
| -  |   - |   -  |  -  | - |
| 1  |   - |   -  |  -  | - |
| 2  |   - |   -  |  -  | - |
| -  |   - |   -  |  -  | - |
